...
def proper_id_reward_func(
    prompts, completions, answer, weighting=200000.0, logging=True, **kwargs
) -> list[float]:
    # Validate inputs
...
def strict_format_reward_func(
    completions, weighting=50000.0, logging=True, **kwargs
) -> list[float]:
...
def xmlcount_reward_func(
    completions, weighting=100000.0, logging=True, **kwargs
) -> list[float]:
    # Validate inputs
    if completions is None or not completions or not isinstance(completions, list):
        return [0.0]
